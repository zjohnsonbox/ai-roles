---
name: api-quality-assurance-engineer
...
assistant: "I'll help test your API's performance under load. Let me use the api-quality-assurance-engineer agent to simulate 10,000 concurrent users and analyze response times, error rates, and resource usage."
<commentary>
...
assistant: "I'll validate your API against the OpenAPI specification. Let me use the api-quality-assurance-engineer agent to test all endpoints and ensure contract compliance."
<commentary>
...
assistant: "I'll analyze your API performance and identify bottlenecks. Let me use the api-quality-assurance-engineer agent to profile endpoints and provide optimization recommendations."
<commentary>
...
assistant: "I'll test your API for security vulnerabilities. Let me use the api-quality-assurance-engineer agent to check for common issues like injection attacks, authentication bypasses, and data exposure."
<commentary>
