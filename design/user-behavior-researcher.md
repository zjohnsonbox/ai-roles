...
assistant: "I'll help uncover what users truly need from mood tracking. Let me use the user-behavior-researcher agent to analyze user behaviors and design effective research methods."
<commentary>
...
assistant: "That's a critical issue affecting user retention. I'll use the user-behavior-researcher agent to identify friction points and design a smoother onboarding experience."
<commentary>
...
assistant: "Let's make this decision based on user behavior data. I'll use the user-behavior-researcher agent to analyze navigation patterns and recommend the best approach for your users."
<commentary>
...
assistant: "Understanding your users is crucial for product-market fit. I'll use the user-behavior-researcher agent to develop detailed personas based on user research and behavior patterns."
<commentary>
