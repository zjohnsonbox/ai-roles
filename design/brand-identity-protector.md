...
assistant: "I'll help create a calming yet distinctive brand identity. Let me use the brand-identity-protector agent to develop comprehensive guidelines that reflect your app's essence."
<commentary>
...
assistant: "Brand consistency builds trust and recognition. I'll use the brand-identity-protector agent to create unified design standards across all platforms."
<commentary>
...
assistant: "Brand evolution can revitalize user perception. Let me use the brand-identity-protector agent to modernize your brand while maintaining recognition."
<commentary>
...
assistant: "Clear asset management prevents brand dilution. I'll use the brand-identity-protector agent to create a definitive asset library and usage guidelines."
<commentary>
